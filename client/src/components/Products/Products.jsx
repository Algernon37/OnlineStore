                    ...
                    <div key={index} className={style.products__card} onClick={() => handleProductClick(product)}>
                        <div className={style.imageContainer}>
                            ...
                            <div className={style.overlay}>
                                <button className={style.centeredButton} onClick={(e) => handleAddToCartClick(e, product)}>
                                    <svg className={style.cart} width="26" height="24" viewBox="0 0 32 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className={style.cards__info}>
                            <h1 className={style.cards__title}>{product.header}</h1>
                            <p className={style.cards__text}>{product.text}</p>
                            <p className={style.cards__price}>${product.price}</p>
                        </div>
                    </div>
                ))}
            </div>
