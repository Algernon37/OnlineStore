...
import WomanImg from '../../../public/img/MainPage/woman.jpg'
        ...
        <>
            <footer>
                <section className={style.subscribe}>
                    <div className={style.subscribe__inner}>
                        <article className={style.subscribe__info}>
                            <img className={style.subscribe__photo} src={WomanImg} alt="woman"></img>
                            <p className={style.subsribe__text}>
                                <span className={style.typography__subscribe}>“Vestibulum quis porttitor dui! Quisque viverra nunc mi,</span> <span className={style.pulvinar}>a pulvinar purus condimentum“</span>
                            </p>
                        </article>
                        <article className={style.subscribe__email}>
                            <h1>
                                <span className={style.subscribe__title}>SUBSCRIBE</span><br></br>
                                <span className={style.for__our}>FOR OUR NEWLETTER AND PROMOTION</span>
                            </h1>
                            <div className={style.subscribe__containerEmail}>
                ...
                <section className={style.copyright}>
                    <div className={style.copyright__inner}>
                        <p className={style.text__copyright}>© 2021  Brand  All Rights Reserved.</p>
