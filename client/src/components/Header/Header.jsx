...
import logo from '../../../public/img/MainPage/logo.png';
import style from './style/Header.module.sass'
import { Link } from 'react-router-dom';

const Header = ({ introRef }) => {
        ...
        <>
            <header id="header" ref={headerRef}>
                <div className={style.header__inner}>
                    ...
                    <div className={style.button__copy}>
                        <div className={style.burger} id="burgerMenu" ref={burgerMenuRef}>
                            <div className={style.burger__menu}>
                                <svg width="32" height="23" viewBox="0 0 32 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M0 23V20.31H32V23H0ZM0 12.76V10.07H32V12.76H0ZM0 2.69V0H32V2.69H0Z" fill="#E8E8E8" />
                                </svg>
                            </div>
                            <nav className={style.nav} id="nav" ref={navRef}>
                                <h1 className={style.burger__title}>MENU</h1>
                                <h1 className={style.burger__titles}>MAN</h1>
                                <div className={style.burger__links}>
                                    <Link className={style.nav__link} to="/catalog">NEW ARRIVALS</Link>
                                    <Link className={style.nav__link} to="/cart">GO TO CART</Link>
                                    <Link className={style.nav__link} to="/registration">GO TO REGISTRATION</Link>
                                    <Link className={style.nav__link} to="#">Accessories</Link>
                                    <Link className={style.nav__link} to="#">Bags</Link>
                                    <Link className={style.nav__link} to="#">Denim</Link>
                                    <Link className={style.nav__link} to="#">Testimonials</Link>
                                    <Link className={style.nav__link} to="#">T-Shirts</Link>
                                </div>
                                <h1 className={style.burger__titles}>WOMAN</h1>
                                <div className={style.burger__links}>
                                    <Link className={style.nav__link} to="#">Accessories</Link>
                                    <Link className={style.nav__link} to="#">Jackets & Coats</Link>
                                    <Link className={style.nav__link} to="#">Polos</Link>
                                    <Link className={style.nav__link} to="#">T-Shirts</Link>
                                    <Link className={style.nav__link} to="#">Shirts</Link>
                                </div>
                                <h1 className={style.burger__titles}>KIDS</h1>
                                <div className={style.burger__links}>
                                    <Link className={style.nav__link} to="#">Accessories</Link>
                                    <Link className={style.nav__link} to="#">Jackets & Coats</Link>
                                    <Link className={style.nav__link} to="#">Polos</Link>
                        ...
                        <Link to="/registration">
                            <svg className={style.men} width="32" height="23" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <Link to="/cart">
                            <svg className={style.basket} width="32" height="23" viewBox="0 0 32 29" fill="none" xmlns="http://www.w3.org/2000/svg">
